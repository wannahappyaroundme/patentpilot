 ...
 */
/**
 * 등급 컷오프 동기화 기준일: 2026-06-07.
 * 실측: 활성 풀 104,582건 · max patent_rank = 83 · 분포 S(0.0%) / A(7.4%) / B(40.9%) / C(33.6%) / D(18.1%)
 */
export const GRADE_CUTOFFS = {
  S: 80, // 학술 절대 기준 (실측 5건 · 이상치 극상위)
  A: 65, // 학술 절대 기준 (실측 7,767건)
  B: 56, // 분위수 기반 (≥56 · 실측 42,748건 · 풀 상위 약 40%)
  C: 48, // 분위수 기반 (≥48 · 실측 35,136건 · 풀 중위 약 34%)
  // D: < 48 (실측 18,926건 · 풀 하위 약 18%)
} as const;
