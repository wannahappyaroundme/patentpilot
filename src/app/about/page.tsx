    ...
    <div className="space-y-12 py-12">
      <section className="max-w-3xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-ink-500">
          대학·정출연이 보유한 R&D 특허 37만 건 중, 연차료 부담이 본격화되는 출원 8년차 이상의 활성 매물 104,582건을
          데이터로 직접 식별합니다. 그중 절반(52,554건, 50.2%)이 8~14년차 임박 구간으로, 매도 동기가 곧 임계점을
          넘는 매물입니다. 이를 기술이 필요한 기업과 매칭하고, 거래 성사 시 매칭 수수료로 수익화합니다.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-ink-100 bg-ink-50/50 p-8">
        ...
        <ul className="mt-4 grid gap-3 text-sm text-ink-700 sm:grid-cols-2">
          ...
          <li>· 출원 2006~2022년 활성 매물 풀 <b>104,582건</b> (실측, 2026-06-07)</li>
          <li>· 🔴 긴급 19,723건 (18.9%) · 🟡 임박 52,554건 (50.2%, 최대 구간) · 🟢 일반 32,305건 (30.9%) · 기타 101건 (실측)</li>
          <li>· 대학 69,777건 (66.7%) · 정출연 34,704건 (33.2%) · 기타 101건 (실측)</li>
        </ul>
      </section>
