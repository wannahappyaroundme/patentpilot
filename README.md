...
대학·정출연이 보유한 R&D 특허 158,777건 중 **곧 유지비를 포기할 매물**을 자동 발굴해 매수 기업과 매칭합니다.
...
> **"한국 대학·정출연이 가진 잠자는 특허 158,777건 중, 유지비 부담으로 매도 동기가 가장 강한 매물을 발굴해 매수 기업과 거래 매칭하는 AI 코파일럿"**
...
| **매물 검색** | `/market` | 158,777건 풀에서 IPC/기관/긴급도/잔여년/공동출원 필터 + 5종 정렬 + 자동완성 + PDF 출력 |
...
- **매물 풀**: 158,777건 (KIPRIS Plus 유료 API 기반)
  - 대학 산학협력단 105,562건 + 정부출연연구기관(GRI) 53,039건
  - 긴급(🔴 15~20년차) 24,677 · 임박(🟡 8~14년) 57,933 · 일반(🟢 4~7년) 76,167
- **매수 후보 기업 시드**: 83개사 (삼성전자·LG·SK·현대·포스코·셀트리온·KT·NAVER 등)
- **IPC ↔ 기업 매핑**: 199건 (가중치 기반 매칭)
- **발명자 정보**: 100% (158,777건 모두 발명자명 포함)
