...
대학·정출연이 보유한 활성 R&D 특허 104,582건 — 그중 절반 이상이 연차료가 급등하는 8~14년차 임박 구간 — 에서 **곧 유지비를 포기할 매물**을 자동 발굴해 매수 기업과 매칭합니다.
...
- **매물 풀**: 104,582건 (KIPRIS Plus 유료 API 기반)
  - 대학 산학협력단 69,777건 (66.7%) + 정부출연연구기관(GRI) 34,704건 (33.2%) + 기타 101건 (실측)
  - 긴급(🔴 15~20년차) 19,723 (18.9%) · 임박(🟡 8~14년) 52,554 (50.2%, 최대 구간) · 일반(🟢 4~7년) 32,305 (30.9%) · 기타 101 (실측)
